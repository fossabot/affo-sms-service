...
# python setup.py build_sphinx
# updates documentation at http://packages.python.org/affo-sms-service/
try:
...
with open("affo_sms_service/__init__.py", "rb") as f:
...
setup(
    ...
    url="https://github.com/affoio/affo-sms-service",
    ...
    entry_points={"console_scripts": ["affo-sms-service = affo_sms_service.cli:manager.run"]},
)
